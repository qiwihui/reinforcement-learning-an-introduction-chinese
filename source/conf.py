...
htmlhelp_basename = 'reinforcement-learning-an-introduction-chinesedoc'
...
texinfo_documents = [
    (master_doc, 'reinforcement-learning-an-introduction-chinese', 'reinforcement-learning-an-introduction-chinese Documentation',
     author, 'reinforcement-learning-an-introduction-chinese', 'One line description of project.',
     'Miscellaneous'),
]
